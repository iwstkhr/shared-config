...
This repository is private, so other repositories can call the workflow only after enabling **Settings → Actions → General → Access → Accessible from repositories owned by the user**.
